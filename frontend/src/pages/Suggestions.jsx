...
const PRIORITIES = [
  ...
  { value: "helpful", label: "Would really help", description: "Makes a real difference to how I use Our Little Village" },
    ...
    <div className="min-h-screen bg-background  lg:pl-60 lg:pb-0">
      ...
      <main className="max-w-3xl mx-auto px-4 pt-16 lg:pt-8">
        ...
        <p className="text-muted-foreground mb-8">
          Your ideas make Our Little Village better. Tell us what you'd love to see.
        </p>
