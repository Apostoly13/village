...
export default function Stall({ user }) {
  ...
  if (!isPremium) {
    return (
      <div className="min-h-screen bg-background pb-20 lg:pb-0">
        ...
        <main className="max-w-2xl mx-auto px-4 pt-20 lg:pt-24 pb-16 flex flex-col items-center text-center gap-6 py-20">
  ...
  return (
    <div className="min-h-screen bg-background pb-20 lg:pb-0">
      ...
      <main className="max-w-5xl mx-auto px-4 pt-20 lg:pt-24 pb-16">
        {/* Header */}
...
function MyListingsTab({ user, navigate }) {
  ...
  const STATUS_LABELS = { active: "Active", sold: "Sold", swapped: "Swapped", gone: "Gone", closed: "Closed" };
  const STATUS_COLORS = { active: "text-emerald-600 bg-emerald-500/10", sold: "text-muted-foreground bg-secondary", swapped: "text-sky-600 bg-sky-500/10", gone: "text-amber-600 bg-amber-500/10", closed: "text-muted-foreground bg-secondary" };
